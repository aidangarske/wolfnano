...
.PHONY: host kstest tstest rectest ksharetest hstest wctest msgtest chtest test clean
test: host kstest tstest rectest ksharetest hstest wctest msgtest chtest ## build + run all local self-tests

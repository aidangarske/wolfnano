...
/**
 * TLS wire encode/decode primitives. Sticky error model: once a write overruns
 * the buffer or a read runs short, err latches and later calls are no-ops, so
 * call sites validate once.
 */

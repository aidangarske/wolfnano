 ...
 * Kept: ECDH (x25519 only), AES-128-GCM, SHA-256, HKDF/HMAC, external RNG.
 * Dropped vs the cert config: all RSA, all ECDSA, RSA/ECC public-key verify.
 * Variant (a): x25519 (Curve25519) key exchange only. */

#ifndef WN_FP_MB4_CRYPTO_CONFIG_PSK_X25519_H
#define WN_FP_MB4_CRYPTO_CONFIG_PSK_X25519_H
...
/* PSA_WANT_ECC_MONTGOMERY_255 stays enabled from the stock config */
...
#endif /* WN_FP_MB4_CRYPTO_CONFIG_PSK_X25519_H */
